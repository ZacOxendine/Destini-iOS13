...
struct StoryBrain {
    let stories = [
        Story(
            ...
            choice2: "Well, I don't have many options. Better ask him if he's a murderer.", choice2Destination: 3
        ),
        Story(
            ...
            choice1: "I love Elton John! Hand him the cassette tape.", choice1Destination: 2,
        ...
        Story(
            ...
            choice1: "At least he's honest. I'll climb in.", choice1Destination: 1,
            choice2: "Wait, I know how to change a tire.", choice2Destination: 5
        ),
        Story(
